                                    ...
                                    <div className="slider-container">
                                        <div className="slide flex mb-16 items-start">
                                            ...
                                            <div className="max-w-lg">
                                                ...
                                                <p className="text-xl text-gray-400">
                                                    ThinkSpire AI revolutionizes
                                                    the way you create content.
                                                    Our intelligent algorithms
                                                    generate high-quality,
                                                    engaging material, saving
                                                    you time and enhancing your
                                                    creative output.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="slide flex mb-16 items-start">
                                            ...
                                            <div className="max-w-lg">
                                                ...
                                                <p className="text-xl text-gray-400">
                                                    Whether it’s blog posts,
                                                    marketing copy, or creative
                                                    stories, ThinkSpire AI
                                                    tailors content to your
                                                    specific needs, ensuring
                                                    each piece is perfectly
                                        ...
                                        <div className="slide flex items-start">
                                            ...
                                            <div className="max-w-lg">
                                                ...
                                                <p className="text-xl text-gray-400">
                                                    ...
                                                    various platforms,
                                                    ThinkSpire AI becomes a
                                                    natural extension of your
                                                    workflow, making content
