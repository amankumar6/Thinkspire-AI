                    ...
                    {tiers.map((tier) => (
                        <div
                            ...
                            className={classNames(
                                ...
                                "rounded-3xl p-8 xl:p-10 transition-all duration-300 hover:scale-105"
                            )}
                        >
                            ...
                            <button
                                ...
                                className={classNames(
                                    ...
                                    "mt-6 block w-full rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 cursor-pointer"
                                )}
                            >
                                Buy plan
                            </button>
